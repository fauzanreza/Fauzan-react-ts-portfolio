...
export const projectsData = [
  {
    ...
    category: "web",
    type: "client",
    liveUrl: "https://iplatinum.telkomuniversity.ac.id/",
  },
  {
    id: 2 ,
    title: "E-Commerce API",
    description: "Simple API Service for E-commerce application.",
    image: "https://images.unsplash.com/photo-1546514355-7fdc90ccbd03?q=80&w=2000",
    techs: ["Go", "Postgresql", "Gin"],
    category: "api",
    type: "personal",
    repoUrl: "https://github.com/fauzanreza/go-gin-gorm-ecommerce-api",
  },
  {
    id: 3,
    title: "Hotel Reservation API",
    description: "Simple API Service for Hotel Reservation application.",
    image: "https://images.unsplash.com/photo-1546514355-7fdc90ccbd03?q=80&w=2000",
    techs: ["PHP", "Laravel", "MySQL"],
    category: "api",
    type: "personal",
    repoUrl: "https://github.com/fauzanreza/laravel-hotel-reservation",
  }
];
